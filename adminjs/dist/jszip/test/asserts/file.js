...
QUnit.module(
    "file", function () {
        ...
        JSZipTestUtils.testZipFile(
            "Zip text, folder and image", "ref/all.zip", function (assert, expected) {
                var zip = new JSZip();
                zip.file("Hello.txt", "Hello World\n");
        ...
        JSZipTestUtils.testZipFile(
            "Add a file to overwrite", "ref/text.zip", function (assert, expected) {
                var zip = new JSZip();
        ...
        JSZipTestUtils.testZipFile(
            "Zip text file with date", "ref/text.zip", function (assert, expected) {
                var zip = new JSZip();
        ...
        JSZipTestUtils.testZipFile(
            "Zip image file", "ref/image.zip", function (assert, expected) {
                var zip = new JSZip();
        ...
        JSZipTestUtils.testZipFile(
            "add file: from XHR (with bytes > 255)", "ref/text.zip", function (assert, textZip) {
                var zip = new JSZip();
        ...
        QUnit.test(
            "add file: wrong string as base64", function (assert) {
                var zip = new JSZip();
        ...
        QUnit.test(
            "add file: data url instead of base64", function (assert) {
                var zip = new JSZip();
        ...
        var _actualTestFileDataGetters = {
            testGetter : function (assert, opts, askedType) {
                ...
                var done = assert.async();
                opts.zip.file("file.txt").async(askedType).then(
                    function (result) {
        ...
        QUnit.test(
            "add file: file(name, undefined)", function (assert) {
        ...
        QUnit.test(
            "add file: file(name, null)", function (assert) {
                var zip = new JSZip();
        ...
        QUnit.test(
            "add file: file(name, stringAsText)", function (assert) {
                var zip = new JSZip();
        ...
        QUnit.test(
            "add file: file(name, stringAsBinary)", function (assert) {
                var zip = new JSZip();
        ...
        QUnit.test(
            "add file: file(name, array)", function (assert) {
                var zip = new JSZip();
        ...
        QUnit.test(
            "add file: file(name, base64)", function (assert) {
                var zip = new JSZip();
        ...
        QUnit.test(
            "add file: file(name, unsupported)", function (assert) {
                var done = assert.async();
                var zip = new JSZip();
        ...
        if (JSZip.support.uint8array) {
            QUnit.test(
                "add file: file(name, Uint8Array)", function (assert) {
        ...
        if (JSZip.support.arraybuffer) {
            QUnit.test(
                "add file: file(name, ArrayBuffer)", function (assert) {
        ...
        if (JSZip.support.blob) {
            QUnit.test(
                "add file: file(name, Blob)", function (assert) {
                    var zip = new JSZip();
        ...
        if (typeof Promise !== "undefined") {
            QUnit.test(
                "add file: file(name, native Promise)", function (assert) {
        ...
        QUnit.test(
            "add file: file(name, polyfill Promise[string] as binary)", function (assert) {
                var str2promise = function (str) {
                    return new JSZip.external.Promise(
                        function (resolve) {
                            setTimeout(
                                function () {
                                    resolve(str);
        ...
        QUnit.test(
            "add file: file(name, polyfill Promise[string] force text)", function (assert) {
                var str2promise = function (str) {
                    return new JSZip.external.Promise(
                        function (resolve) {
                            setTimeout(
        ...
        */
        ...
        if (JSZip.support.blob) {
            QUnit.test(
                "add file: file(name, polyfill Promise[Blob])", function (assert) {
        ...
        if (JSZip.support.nodebuffer) {
            QUnit.test(
                "add file: file(name, Buffer)", function (assert) {
                    var str2buffer = function (str) {
        ...
        QUnit.test(
            "Zip folder() shouldn't throw an exception", function (assert) {
                var zip = new JSZip();
                try {
                    zip.folder();
        ...
        JSZipTestUtils.testZipFile(
            "Zip empty folder", "ref/folder.zip", function (assert, expected) {
                var zip = new JSZip();
                zip.folder("folder");
                var done = assert.async();
                zip.generateAsync({type:"binarystring"}).then(
        ...
        QUnit.test(
            "file() creates a folder with dir:true", function (assert) {
                var zip = new JSZip();
                zip.file(
                    "folder", null, {
                        dir : true
        ...
        QUnit.test(
            "file() creates a folder with the right unix permissions", function (assert) {
                var zip = new JSZip();
                zip.file(
                    "folder", null, {
        ...
        QUnit.test(
            "file() creates a folder with the right dos permissions", function (assert) {
                var zip = new JSZip();
                zip.file(
                    "folder", null, {
        ...
        QUnit.test(
            "A folder stays a folder when created with file", function (assert) {
        ...
        QUnit.test(
            "file() adds a slash for directories", function (assert) {
                var zip = new JSZip();
                zip.file(
                    "folder_without_slash", null, {
                        dir : true
                    }
                );
                zip.file(
                    "folder_with_slash/", null, {
                        dir : true
                    }
                );
        ...
        QUnit.test(
            "folder() doesn't overwrite existing entries", function (assert) {
                var referenceComment = "my comment";
                var zip = new JSZip();
                zip.file(
                    "folder", null, {
        ...
        QUnit.test(
            "createFolders works on a file", function (assert) {
                var zip = new JSZip();
        ...
        QUnit.test(
            "createFolders works on a folder", function (assert) {
                var zip = new JSZip();
        ...
        QUnit.test(
            "folder follows the default createFolders settings", function (assert) {
                var zip = new JSZip();
        ...
        QUnit.test(
            "A folder stays a folder", function (assert) {
                var zip = new JSZip();
                zip.folder("folder/");
        ...
        QUnit.test(
            "Folders are created by default", function (assert) {
                var zip = new JSZip();
        ...
        QUnit.test(
            "Folders can be avoided with createFolders", function (assert) {
                var zip = new JSZip();
                zip.file("test/Readme", "Hello World!\n", {createFolders: false});
                assert.ok(zip.files["test/Readme"], "the file exists");
        ...
        QUnit.test(
            "Finding a file", function (assert) {
                var zip = new JSZip();
                ...
                var done = assert.async();
                zip.file("Readme.French").async("string").then(
                    function (content) {
        ...
        QUnit.test(
            "Finding a file (text search) with a relative folder", function (assert) {
                var zip = new JSZip();
                ...
                zip.file("files/translation/Readme.French").async("string").then(
                    function (content) {
                        assert.equal(content, "Bonjour tout le monde!\n", "finding file with the full path");
                        done();
                    }
                )["catch"](JSZipTestUtils.assertNoError);
                zip.folder("files").file("translation/Readme.French").async("string").then(
                    function (content) {
                        assert.equal(content, "Bonjour tout le monde!\n", "finding file with a relative path");
                        done();
                    }
                )["catch"](JSZipTestUtils.assertNoError);
                zip.folder("files/translation").file("Readme.French").async("string").then(
                    function (content) {
                        assert.equal(content, "Bonjour tout le monde!\n", "finding file with a relative path");
                        done();
                    }
        ...
        QUnit.test(
            "Finding files (regex) with a relative folder", function (assert) {
                var zip = new JSZip();
                zip.folder("files/default").file("Readme", "Hello World!\n");
                zip.folder("files/translation").file("Readme.French", "Bonjour tout le monde!\n");
                zip.folder("files").folder("translation").file("Readme.Pirate", "Ahoy m'hearty!\n");
        ...
        QUnit.test(
            "Finding folders", function (assert) {
                var zip = new JSZip();
        ...
        QUnit.test(
            "Finding folders with relative path", function (assert) {
                var zip = new JSZip();
                zip.folder("root/").folder("sub1/");
                zip.folder("root/sub2/subsub1");
        ...
        QUnit.test(
            "ZipObject attributes", function (assert) {
                var date = new Date("July 17, 2009 14:36:57");
                var zip = new JSZip();
        ...
        QUnit.test(
            "generate uses updated ZipObject date attribute", function (assert) {
                var date = new Date("July 17, 2009 14:36:57");
                var zip = new JSZip();
