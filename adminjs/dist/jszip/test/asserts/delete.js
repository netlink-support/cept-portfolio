...
JSZipTestUtils.testZipFile(
    "Delete file", "ref/text.zip", function (assert, expected) {
        var zip = new JSZip();
...
JSZipTestUtils.testZipFile(
    "Delete file in folder", "ref/folder.zip", function (assert, expected) {
        var zip = new JSZip();
...
JSZipTestUtils.testZipFile(
    "Delete file in folder, with a relative path", "ref/folder.zip", function (assert, expected) {
        var zip = new JSZip();
...
JSZipTestUtils.testZipFile(
    "Delete folder", "ref/text.zip", function (assert, expected) {
        var zip = new JSZip();
...
JSZipTestUtils.testZipFile(
    "Delete folder with a final /", "ref/text.zip", function (assert, expected) {
        var zip = new JSZip();
        zip.folder("remove").file("Remove.txt", "This folder and file should be deleted\n");
        zip.file("Hello.txt", "Hello World\n");
        zip.remove("remove/");
...
JSZipTestUtils.testZipFile(
    "Delete unknown path", "ref/text.zip", function (assert, expected) {
        var zip = new JSZip();
        zip.file("Hello.txt", "Hello World\n");
...
JSZipTestUtils.testZipFile(
    "Delete nested folders", "ref/text.zip", function (assert, expected) {
        var zip = new JSZip();
        zip.folder("remove").file("Remove.txt", "This folder and file should be deleted\n");
...
JSZipTestUtils.testZipFile(
    "Delete nested folders from relative path", "ref/folder.zip", function (assert, expected) {
        var zip = new JSZip();
        zip.folder("folder");
