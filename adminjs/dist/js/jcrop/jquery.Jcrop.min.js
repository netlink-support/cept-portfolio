...
(function (a) {
    a.Jcrop = function (b, c) {
        ...
        function n(b)
        {
            typeof b != "object" && (b = {}), d = a.extend(d, b), a.each(
                ["onChange", "onSelect", "onRelease", "onDblClick"], function (a, b) {
        ...
        function w(a)
        {
            ...
            return _.setPressed(b), bb.update(), bc.activateHandlers(
                x, v, a.type.substring(0, 5) === "touch"
            ), bd.watchKeys(), a.stopPropagation(), a.preventDefault(), !1
        }
        function x(a)
        {
            ...
            return{
                ...
                bb = function () {
                    ...
                    var b,
                            ...
                            g = {},
                            h = !1;
                    d.dragEdges && a.isArray(d.createDragbars) && o(d.createDragbars), a.isArray(d.createHandles) && q(d.createHandles), d.drawBorders && a.isArray(d.createBorders) && p(d.createBorders), a(document).bind(
                        "touchstart.jcrop-ios", function (b) {
                ...
                bc = function () {
                    function f(b)
                    {
                        ...
                        b ? a(document).bind(
                            "touchmove.jcrop"
                            , k
                        ).bind("touchend.jcrop", l) : e && a(document).bind("mousemove.jcrop", h).bind("mouseup.jcrop", i)
                    }
                    function g()
                    {
                        M.css(
        ...
        return this.each(
            function () {
                if (a(this).data("Jcrop")) {
                    ...
                    this.tagName == "IMG" ? a.Jcrop.Loader(
                        this, function () {
                            a(this).css(
                                {
                                    display: "block",
        ...
        var e = a(b),
                f = e[0];
        e.bind("load.jcloader", g).bind(
            "error.jcloader", function (b) {
