        ...
        $("#filer_input2").filer(
            {
                ...
                onRemove: function (itemEl, file, id, listEl, boxEl, newInputEl, inputEl) {
                    ...
                    $.post(js_base + "remove-slide", {file: file_name, course_code: course_code_js});
                    //total_visuals--;
                    //$('#total_visuals').val(total_visuals);
