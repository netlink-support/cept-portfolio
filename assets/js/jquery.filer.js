    ...
    $.fn.filer = function (q) {
        return this.each(
            function (t, r) {
                    ...
                    f = {
                            ...
                            _box: function (params) {
                                ...
                                if (l.length < 1) {
                                    ...
                                    l.append(f._assets.textParse(n.templates.box))
                                            .appendTo(appendTo);
                                    l.on(
                                        'click', n.templates._selectors.remove, function (e) {
                                            e.preventDefault();
                        ...
                        _onSelect: function (i) {
                            if (n.uploadFile && !$.isEmptyObject(n.uploadFile)) {
                                if (!n.uploadFile.synchron || (n.uploadFile.synchron && $.grep(
                                    f._itFl, function (a) {
                                        return a.ajax
                                    }
                                ).length == 0)
                        ...
                        _remove: function (e, el) {
                            ...
                            var excl_input = function (val) {
                                ...
                                if (input.length == 0) {
                                    input = $(
                                        '<input type="hidden" name="jfiler-items-exclude-' + (n.excludeName ? n.excludeName : (s.attr("name")
                        ...
                        _assets: {
                            ...
                            textParse: function (text, opts) {
                                ...
                                case "string":
                                        return text.replace(
                                            /\{\{fi-(.*?)\}\}/g, function (match, a) {
                                                a = a.replace(/ /g, '');
                                                if (a.match(/(.*?)\|limitTo\:(\d+)/)) {
                                                    return a.replace(
                                                        /(.*?)\|limitTo\:(\d+)/, function (match, a, b) {
                                                            var a = (opts[a] ? opts[a] : ""),
                                                            str = a.substring(0, b);
                ...
                s.on(
                    "filer.append", function (e, data) {
                        f._append(e, data)
                    }
                ).on(
                    "filer.remove", function (e, data) {
                        data.binded = true;
                        f._remove(e, data);
                    }
                ).on(
                    "filer.reset", function (e) {
                        f._reset();
                        f._clear();
                        return true;
                    }
                ).on(
                    "filer.generateList", function (e, data) {
                        return f._getList(e, data)
                    }
                ).on(
                    "filer.retry", function (e, data) {
